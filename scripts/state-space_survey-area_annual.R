...
ggsave(paste0('./figures/p_together_CALFYR_',date,'.png'), p_together, dpi = 300, width = 200, height = 100, units = "mm")

phi_p_together<-ggpubr::ggarrange(p_together,phi_together, common.legend = T, labels = "auto", ncol = 1, legend = "bottom", align = "v")

ggsave(paste0('./figures/phi_p_together2_CALFYR_',date,'.png'), phi_p_together, dpi = 300, width = 250, height = 200, units = "mm")
